...
async def health(_): return JSONResponse({"status":"ok","version":"1.3.2-drive-resolution","mcp_apps":True,"stateless_http":True,"endpoint":"/mcp","app_auth_tools":2,"total_tools":len(_CAPTURED)+1})
@asynccontextmanager
...
app=CORSMiddleware(app=starlette_app,allow_origins=["https://chatgpt.com","https://chat.openai.com"],allow_methods=["GET","POST","DELETE","OPTIONS"],allow_headers=["*"],expose_headers=["Mcp-Session-Id"],allow_credentials=False)
